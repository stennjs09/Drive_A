...
void sendDataToServer(BuildContext context) async {
  ...
  if (selectedType == 'Interieur') {
    ...
    final url = Uri.parse(
        '$urlServer/API2/150.php?ApiKey=FGSFDG1312SFG32&selectedCategory=$selectedCategory&selectedType=$selectedType&price=$price&temp_esp=0,ok');
    ...
    final url = Uri.parse(
        '$urlServer/API2/150.php?ApiKey=FGSFDG1312SFG32&selectedCategory=$selectedCategory&selectedType=$selectedType&price=$price&temp_esp=$temp');
